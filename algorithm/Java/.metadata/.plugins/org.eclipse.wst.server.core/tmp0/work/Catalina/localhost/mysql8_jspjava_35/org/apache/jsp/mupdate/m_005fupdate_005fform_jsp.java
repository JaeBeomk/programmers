 ...
 * Generated at: 2022-11-18 12:28:36 UTC
...
if(S_LEVEL == null){
	...
	if(S_LEVEL.equals("구매자")){
      ...
      out.write("<tr>\r\n");
      out.write("	<td>아이디</td>\r\n");
      out.write("	<td><input type=\"text\" name=\"m_id\" size=\"20\" readonly value=\"");
      out.print( dbid );
      out.write("\"></td>\r\n");
      out.write("<tr>\r\n");
      out.write("<tr>\r\n");
      ...
      out.write("\r\n");
      out.write("<!-- \r\n");
      out.write("1단계 : 드라이버로딩 2단계 : DB연결 \r\n");
      out.write("3단계 : SELECT * FROM tb_member WHERE m_id='id005'\r\n");
      out.write("SELECT * FROM tb_member WHERE m_id=? 쿼리 준비\r\n");
      out.write("4단계 : 쿼리 실행 후 결과 담는다.\r\n");
      out.write("5단계 : 쿼리 실행 결과 담겨있는 값을 수정화면에 뿌려준다\r\n");
      out.write("6,7단계 : 객체 종료  \r\n");
      out.write("-->");
