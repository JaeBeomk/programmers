...
%>      
      ...
      <td>
<a href="<%= request.getContextPath() %>/mgupdate/mg_update_form.jsp?g_code=<%= rs.getString("g_code")%>">수정버튼</a>         
      </td>
      <td>
<a href="<%= request.getContextPath() %>/mgdelete/mg_delete_action.jsp?g_code=<%= rs.getString("g_code")%>">삭제버튼</a>         
      </td>
   </tr>         
<%      
   }      
