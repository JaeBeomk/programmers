...
%>
<!-- 1-1 로그인 전 화면 시작 -->
<a href="<%= request.getContextPath() %>/uinsert/u_insert_form.jsp">01회원가입</a><br/><br/>
...
%>
<a href="<%= request.getContextPath() %>/uinsert/u_insert_form.jsp">01회원가입</a>
...
%>
<a href="<%= request.getContextPath() %>/uinsert/u_insert_form.jsp">01회원가입</a>
<a href="<%= request.getContextPath() %>/usearch/u_search_list.jsp">02회원검색</a>
<a href="#">03상품등록</a>
<a href="#">04상품검색</a>	<br/><br/>
<%
	}
